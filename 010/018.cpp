...
int maxTriangleRoute(std::vector<std::vector<int>>& v)
{
	...
	return *std::max_element(v[v.size()-1].begin(), v[v.size()-1].end());
}

int problem19(std::vector<std::vector<int>>& v)
{
	return maxTriangleRoute(v);
}
